                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <p style="font-weight:700;color:#333;font-size:12px" width="260">
                                                Baru saja Anda telah berhasil melakukan perubahan kata sandi untuk aplikasi {{config('app.name')}}
                                                pada tanggal {{\Carbon\Carbon::parse($user->created_at)->format('d M Y H:i')}} <br><br>
                                                Simpan dan ingat baik-baik kata sandi Anda, jangan pernah berikan kata sandi kepada orang lain termasuk
