                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="3"
                                                        ...
                                                        align="center">Isi ulang saldo {{ucwords($data->status)}}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size:0;line-height:0" width="20"> </td>
                                                    <td style="font-weight:700" align="right" valign="top"
                                                        width="260">Top up saldo Aplikasi {{config('app.name')}}</td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top" width="260">Kode Bank Pembayaran</td>
                                                    <td style="font-size:0;line-height:0" width="20"> </td>
                                                    <td style="font-weight:700" align="right" valign="top"
                                                        width="260">
                                                        {{$data->payment->code}} - 
                                                        @switch($data->payment->type)
                                                            @case('VA')
                                                                ...
                                                                @break
                                                            @case('E-WALLET')
                                                                E-wallet {{$data->payment->swift_code}}
                                                                @break
                                                            @case('QRIS')
                                                                {{$data->payment->description}}
                                                                @break
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-weight:700" align="right" valign="top"
                                                        width="260">
                                                        <span class="">
                                                            {{ $data->payment->type == 'QRIS' ? Str::limit($data->va_number, 16, '...') : $data->va_number}}
                                                        </span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" width="260">Biaya Admin</td>
                                                    <td style="font-size:0;line-height:0" width="20"> </td>
                                                    <td style="font-weight:700" align="right" valign="top"
                                                        width="260">
                                                        Rp {{rupiah($data->fee)}}
                                                ...
                                                <tr>
                                                    <td align="left" valign="top"
                                                        ...
                                                        width="260"><strong>Total Pembayaran</strong></td>
                                                    <td style="font-size:0;line-height:0" width="20"> </td>
                                                    <td style="font-weight:700;color:#E71111;font-size:16px"
                                                        align="right" valign="top" width="260">
                                                        <strong>Rp {{rupiah($data->total_payment)}}</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
