                                ...
                                <div class="modal-body">
                                    <form id="postForm" name="postForm" class="form-horizontal" enctype="multipart/form-data">                        
                                        ...
                                        <div class="form-group">
                                            <label for="code" class="control-label">Kode Bank</label>
                                        ...
                                        <div class="form-group">
                                            <label for="icon" class="control-label">File Banner</label>
                                            <div class="form-control-wrap">
                                        ...
                                        <div class="custom-control custom-switch mb-3">
                                            <input type="checkbox" class="custom-control-input" name="status" id="customSwitch2">
                ...
                <div class="card card-stretch">
                    <div class="card-inner-group">
                        ...
                        <div class="card-inner">
                            <table id="tbl_payment" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Icon</th>
                                        <th>Kode Bank</th>
...
$('#savedata').click(function (e) {
    ...
    fd.append('swift_code', $('#swift_code').val());
    fd.append('description', $('#description').val());
    fd.append('type', $('#type').val());
    fd.append('status', $('#customSwitch2').val());
    fd.append('icon',files[0]);
    fd.append('_token',CSRF_TOKEN);

    $.ajax({
        data: fd,
        url: "{{ route('pay-method.store') }}",
        method: "POST",
        contentType: false,
        processData: false,
        dataType: 'json',
...
$('#tbl_payment').on('click','.btn-delete',function(){
    var id = $(this).data('id');
    var deleteConfirm = confirm("Are you sure?");
    if (deleteConfirm == true) {
        $.ajax({
            url: "{{ route('pay-method.delete') }}",
            type: 'POST',
