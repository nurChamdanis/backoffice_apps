...
return [
    ...
    */
    ...
    'back_to_system_url' => config('app.url', 'home'),

    'back_to_system_label' => 'Kembali ke', // Displayed by default: "Back to {{ app.name }}"
    ...
    */
    ...
    'hosts' => [
        ...
        'production' => [
            'name' => 'Production',
            'host' => env('APP_URL').'/v2/log-viewer',
        ],
    ],
