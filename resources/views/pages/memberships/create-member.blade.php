...
<form action="{{ url('simpan-member') }}" method='post'>
{{ csrf_field() }}
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name='name_membership' value="{{ Session::get('name_membership') }}" id="name_membership">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="limit_transaction" class="col-sm-2 col-form-label">Limit Transaction</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" name='limit_transaction' value="{{ Session::get('limit_transaction') }}" id="limit_transaction">
        </div>
    </div>
    <div class="mb-3 row">
