...
<form action="{{ url('simpan-role') }}" method='post'>
{{ csrf_field() }}
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name='name' value="{{ Session::get('name') }}" id="name" placeholder="input name">
        </div>
    </div>
            <input type="hidden" class="form-control" name='guard_name' value="admin" id="guard_name">
