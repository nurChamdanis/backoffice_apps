                                ...
                                <div class="mb-3 row row justify-content-start g-0">
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Signup Ip Address</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['signup_ip_address'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Signup Confirmation Ip Address</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['signup_confirmation_ip_address'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Signup Sm Ip Address</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['signup_sm_ip_address'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Admin Ip Address</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['admin_ip_address'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Updated Ip Address</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['updated_ip_address'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Deleted Ip Address</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['deleted_ip_address'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Saldo Balance</small>
                                                    <div class="fw-bold">
                                        ...
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <div class="fw-bold">
                                                        <?php echo  $data['verification_code'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Fcm</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['fcm'] ; ?>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Is Kyc</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['is_kyc'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Is Outlet</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['is_outlet'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
